...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        if($data_check){
            ...
            $sender = "From: boondocks255@gmail.com";
    ...
    if(isset($_POST['login'])){
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            if(password_verify($password, $fetch_pass)){
                ...
                if($status == 'verified'){
                  ...
                  $_SESSION['password'] = $password;
                    ...
                    $info = "Please verify your email - $email before you continue";
                    $_SESSION['info'] = $info;
                    header('location: user-otp.php');
                }
            }else{
            ...
            $errors['email'] = "You do not have an account.Please click the sign up link below to register.";
        }
    }
